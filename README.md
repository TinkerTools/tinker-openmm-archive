...
simulations. In addition, This branch has been designed for the use of Dual Topology simulation. This branch is designed for use with the tinkerRelative branch within this repository. 
