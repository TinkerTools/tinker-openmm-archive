...
!$OMP& i12,i13,i14,i15,v2scale,v3scale,v4scale,v5scale,use_relative
!$OMP& ,use_group,off2,radmin,epsilon,radmin4,epsilon4,ghal,dhal,
!$OMP& cut2,vlambda,scalpha,scexp,mut1,mut2,c0,c1,c2,c3,c4,c5,
!$OMP&	molcule)
...
c     get the energy and gradient, via soft core if necessary
c
                if((mut1(i).eqv. mut1(k)) .and. (
     &           mut2(k) .eqv. mut2(i))) then
                        uselambda=1.0
