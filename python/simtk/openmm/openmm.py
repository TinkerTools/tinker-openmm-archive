...
class XmlSerializer(_object):
    ...
    __swig_getmethods__["_serializeTabulatedFunction"] = lambda x: _serializeTabulatedFunction
    ...
    __swig_getmethods__["_deserializeTabulatedFunction"] = lambda x: _deserializeTabulatedFunction

    def _serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, paramDerivs, types):
        """_serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, paramDerivs, types) -> std::string"""
        return _openmm.XmlSerializer__serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, paramDerivs, types)
...
def XmlSerializer__serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, paramDerivs, types):
    """XmlSerializer__serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, paramDerivs, types) -> std::string"""
    return _openmm.XmlSerializer__serializeStateAsLists(pos, vel, forces, kineticEnergy, potentialEnergy, time, boxVectors, params, paramDerivs, types)
...
class RPMDIntegrator(Integrator):
    ...
    def _getStateAsLists(self, copy, getPositions, getVelocities, getForces, getEnergy, getParameters, getParameterDerivatives, enforcePeriodic, groups):
        """_getStateAsLists(self, copy, getPositions, getVelocities, getForces, getEnergy, getParameters, getParameterDerivatives, enforcePeriodic, groups) -> PyObject *"""
        return _openmm.RPMDIntegrator__getStateAsLists(self, copy, getPositions, getVelocities, getForces, getEnergy, getParameters, getParameterDerivatives, enforcePeriodic, groups)
...
class Context(_object):
    ...
    def _getStateAsLists(self, getPositions, getVelocities, getForces, getEnergy, getParameters, getParameterDerivatives, enforcePeriodic, groups):
        """_getStateAsLists(self, getPositions, getVelocities, getForces, getEnergy, getParameters, getParameterDerivatives, enforcePeriodic, groups) -> PyObject *"""
